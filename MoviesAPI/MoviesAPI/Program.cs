...
builder.Services.AddDbContext<MoviessDBContext>(options =>
{
   // options.UseSqlServer(cns);
   options.UseInMemoryDatabase(databaseName:"Movies");
});
...
{
    var dataContext=scope.ServiceProvider.GetRequiredService<MoviessDBContext>();
    //Create Database
    //InMemoryDatabase
